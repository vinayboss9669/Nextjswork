      ...
      <section className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        ...
        <div className="md:col-span-6">
          ...
          <div className="mt-6 flex items-center gap-3">
            <button
              onClick={handleAddToCart} // Changed from addToCart to handleAddToCart
            ...
            <Link href="/checkout" className="inline-block">
              <button className="px-4 py-3 border border-pink-100 text-pink-600 rounded-lg hover:bg-pink-50 transition">
                Buy now
              </button>
            </Link>
